  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <h1 style={{ fontSize: '20px', marginTop: '20%', wordSpacing: '-2%' }}>Los Angeles Convention Center</h1>
      </div>
      <p style={{ fontSize: '20px',marginTop: '80px', width: '120px', marginLeft: '40px', wordSpacing: '-2%' }}>Elapsed time</p>
